...
3	35	maggio	1492
	...
	void testECC(int g, String m, int a,String settimana) {
		String sett=Calendario.calend(g,m,a);
		assertTrue("Errore: giorno della settimana errato: doveva essere "+settimana+" ma � "+sett,settimana.contentEquals(sett));
	}
	...
	void testECCBoundary(int g, String m, int a,String settimana) {
		String sett=Calendario.calend(g,m,a);
		assertTrue("Errore: giorno della settimana errato: doveva essere "+settimana+" ma � "+sett,settimana.contentEquals(sett));
	}
 ...
 */
	...
	void test2WiseBoundary(int g, String m, int a,String settimana) {
		String sett=Calendario.calend(g,m,a);
		assertTrue("Errore: giorno della settimana errato: doveva essere "+settimana+" ma � "+sett,settimana.contentEquals(sett));
	}
	...
	void test3WiseBoundary(int g, String m, int a,String settimana) {
		String sett=Calendario.calend(g,m,a);
		assertTrue("Errore: giorno della settimana errato: doveva essere "+settimana+" ma � "+sett,settimana.contentEquals(sett));
	}

//	@ParameterizedTest
//	@CsvFileSource(resources = "..\\2wayextended.csv", numLinesToSkip = 1)	
//	void test2WayExtended(int g, String m, int a,String settimana) {
//		String sett=Calendario.calend(g,m,a);
//		assertTrue("Errore: giorno della settimana errato: doveva essere "+settimana+" ma � "+sett,settimana.contentEquals(sett));
//	}
}
